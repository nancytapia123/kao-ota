<?php
/*****************************************************************************************************************/
/*Archivo: phpMailer/class.phpmailer.php*/
/*Powered By: Factor Evolucion S.A. De C.V*/
/*Auto: Victor Matus*/
/*Version: 267.1*/
/*Fecha de Ultima Modificacion: 26/04/10*/
/*Sección: MAIL*/
/*Funcion: */
/*Descripcion: librerias para el envio de correo electrónico.*/
/*Sintaxis: */
/*Entradas: */
/*Salidas: */
...
class PHPMailer {
  ...
  function SetLanguage($lang_type = 'en', $lang_path = 'language/') {
    if( !(@include $lang_path.'phpmailer.lang-'.$lang_type.'.php') ) {
      ...
      $PHPMAILER_LANG["provide_address"]      = 'Usted debe proporcionar al menos una ' .
      $PHPMAILER_LANG["mailer_not_supported"] = 'El correo no es compatible.';
      $PHPMAILER_LANG["execute"]              = 'No se pudo ejecutar:';
      $PHPMAILER_LANG["instantiate"]          = 'No pude crear una instancia función de correo.';
      $PHPMAILER_LANG["authenticate"]         = 'Error SMTP: No se puede autenticar.';
      $PHPMAILER_LANG["from_failed"]          = 'Las siguientes direcciones de remitente fallaron:';
      ...
      $PHPMAILER_LANG["file_access"]          = 'No es posible acceder al archivo: ';
      $PHPMAILER_LANG["file_open"]            = 'Archivo de error: No se pudo abrir el archivo: ';
      $PHPMAILER_LANG["encoding"]             = 'Desconocido codificación: ';
      $PHPMAILER_LANG["signing"]              = 'Firma de error: ';
    }
